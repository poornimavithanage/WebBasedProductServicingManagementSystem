...
-- Database: `psms`
--
CREATE DATABASE IF NOT EXISTS `psms` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `psms`;
...
(50, 'INC48529', 'BLI1888', 'Conference', 'Polycom', 'PTL333', '3199157456249', '2018-03-24'),
(51, 'INC48529', 'BLI1889', 'Conference', 'Polycom', 'PTL333', '3166592719145', '2018-03-24'),
(52, 'INC48529', 'BLI1890', 'Projectors', 'Panasonic', 'DK256', '2565617596315', '2018-03-24'),
(53, 'INC48529', 'BLI1891', 'Projectors', 'Panasonic', 'DK256', '2627712157263', '2018-03-24'),
(54, 'INC48529', 'BLI1892', 'Projectors', 'Panasonic', 'PA128', '1468143233544', '2018-03-24'),
(55, 'INC48529', 'BLI1893', 'Amplifiers', 'Polycom', 'RX360', '3424443712263', '2018-03-24'),
(56, 'INC48529', 'BLI1894', 'Microphones', 'Polycom', 'PJ50', '3641593518275', '2018-03-24'),
...
(76, 'INC48529', '2018-03-24', 809500.00, 'CUS1003');
...
(128, 35015, 'CUS1001', '2018-10-07', 'New', 'In Progress', '2018-10-07'),
(129, 35015, 'CUS1001', '2018-10-07', 'Technician WIP', 'In Progress', '2018-10-07'),
(130, 35015, 'CUS1001', '2018-10-07', 'Sent to Store', 'In Progress', '2018-10-07'),
(131, 35015, 'CUS1001', '2018-10-07', 'Store Manager WIP', 'In Progress', '2018-10-07'),
(135, 35015, 'CUS1001', '2018-10-07', 'Sent to Technician', 'In Progress', '2018-10-13'),
(154, 35015, 'CUS1001', '2018-10-07', 'Technician WIP', 'In Progress', '2018-10-13'),
(155, 35015, 'CUS1001', '2018-10-07', 'Completed', 'Finished not collected', '2018-10-13'),
(158, 35015, 'CUS1001', '2018-10-07', 'Completed', 'Order Finished', '2018-10-14'),
(159, 35017, 'CUS1004', '2018-10-21', 'New', 'In Progress', '2018-10-21'),
(162, 35017, 'CUS1004', '2018-10-21', 'Technician WIP', 'In Progress', '2018-10-21'),
(163, 35017, 'CUS1004', '2018-10-21', 'Sent to Store', 'In Progress', '2018-10-21'),
(164, 35017, 'CUS1004', '2018-10-21', 'Store Manager WIP', 'In Progress', '2018-10-21'),
(167, 35017, 'CUS1004', '2018-10-21', 'Pending Estimation', 'In Progress', '2018-10-21'),
(168, 35015, 'CUS1001', '2018-10-07', 'Imports Manager WIP', 'In Progress', '2018-10-21'),
(169, 35018, 'CUS1003', '2018-10-23', 'New', 'In Progress', '2018-10-23'),
(170, 35019, 'CUS1003', '2018-10-23', 'New', 'In Progress', '2018-10-23'),
(171, 35020, 'CUS1003', '2018-10-23', 'New', 'In Progress', '2018-10-23'),
(172, 35021, 'CUS1004', '2018-10-23', 'New', 'In Progress', '2018-10-23'),
(173, 35022, 'CUS1004', '2018-10-23', 'New', 'In Progress', '2018-10-23'),
(174, 35023, 'CUS1001', '2018-10-23', 'New', 'In Progress', '2018-10-23'),
(175, 35024, 'CUS1003', '2018-10-23', 'New', 'In Progress', '2018-10-23'),
(176, 35025, 'CUS1001', '2018-10-23', 'New', 'In Progress', '2018-10-23'),
(178, 35018, 'CUS1003', '2018-10-23', 'Technician WIP', 'In Progress', '2018-10-23'),
(179, 35018, 'CUS1003', '2018-10-23', 'Technician WIP', 'In Progress', '2018-10-23'),
(186, 35018, 'CUS1003', '2018-10-23', 'Sent to Store', 'In Progress', '2018-10-24'),
(187, 35033, 'CUS1004', '2018-10-24', 'New', 'In Progress', '2018-10-24'),
(188, 35019, 'CUS1003', '2018-10-23', 'Technician WIP', 'In Progress', '2018-10-24'),
(189, 35019, 'CUS1003', '2018-10-23', 'Sent to Store', 'In Progress', '2018-10-24'),
(190, 35020, 'CUS1003', '2018-10-23', 'Technician WIP', 'In Progress', '2018-10-24'),
(191, 35020, 'CUS1003', '2018-10-23', 'Sent to Store', 'In Progress', '2018-10-24'),
(192, 35018, 'CUS1003', '2018-10-23', 'Store Manager WIP', 'In Progress', '2018-10-24'),
(193, 35018, 'CUS1003', '2018-10-23', 'Pending Estimation', 'In Progress', '2018-10-24'),
(194, 35019, 'CUS1003', '2018-10-23', 'Store Manager WIP', 'In Progress', '2018-10-24'),
(195, 35019, 'CUS1003', '2018-10-23', 'Pending Estimation', 'In Progress', '2018-10-24'),
(196, 35020, 'CUS1003', '2018-10-23', 'Store Manager WIP', 'In Progress', '2018-10-24'),
(197, 35020, 'CUS1003', '2018-10-23', 'Pending Estimation', 'In Progress', '2018-10-24');
...
INSERT INTO `customer_job_tbl` (`job_id`, `customer_id`, `invoice_no`, `job_date`, `serial_no`, `category`, `make`, `model`, `problem_description`, `warranty_type`, `sales_order_no`, `sales_order_date`, `technician_id`, `store_manager_id`, `service_manager_id`, `imports_manager_id`, `job_status`, `technician_status`, `store_manager_status`, `service_manager_status`, `imports_manager_status`, `sms_status`, `current_status`) VALUES
('35015', 'CUS1001', 'INC48527', '2018-10-07', '2862518412789', 'Projectors', 'Infocus', 'S444', 'Lamp not working', 'Supplier Warranty', 'YC4204', '2016-08-25', 'TEC201', 'STMGR401', 'SERMGR000', 'IMPMGR601', 'In Progress', 'Completed', 'Completed', 'Pending', 'Imports Manager WIP', 'Sent', 'Imports Manager WIP'),
('35017', 'CUS1004', 'INC48528', '2018-10-21', '3696648158963', 'Microphones', 'Polycom', 'PJ50', 'Lamp not working ', 'Customer Repair', 'FM9243', '2017-04-17', 'TEC201', 'STMGR401', 'SERMGR000', 'IMPMGR000', 'In Progress', 'Sent to Store', 'Sent to Service Manager', 'Pending', 'Pending', 'Not Sent', 'Sent to Service Manager'),
('35018', 'CUS1003', 'INC48529', '2018-10-23', '3641593518275', 'Microphones', 'Polycom', 'PJ50', 'No Power ', 'Customer Repair', 'FM9243', '2017-04-17', 'TEC201', 'STMGR401', 'SERMGR000', 'IMPMGR000', 'In Progress', 'Sent to Store', 'Sent to Service Manager', 'Pending', 'Pending', 'Not Sent', 'Sent to Service Manager'),
('35019', 'CUS1003', 'INC48529', '2018-10-23', '3199157456249', 'Conference', 'Polycom', 'PTL333', 'No Power', 'Customer Repair', 'AL4830', '2015-04-10', 'TEC201', 'STMGR401', 'SERMGR000', 'IMPMGR000', 'In Progress', 'Sent to Store', 'Sent to Service Manager', 'Pending', 'Pending', 'Not Sent', 'Sent to Service Manager'),
('35020', 'CUS1003', 'INC48529', '2018-10-23', '3166592719145', 'Conference', 'Polycom', 'PTL333', 'No Power', 'Customer Repair', 'AL4830', '2015-04-10', 'TEC201', 'STMGR401', 'SERMGR000', 'IMPMGR000', 'In Progress', 'Sent to Store', 'Sent to Service Manager', 'Pending', 'Pending', 'Not Sent', 'Sent to Service Manager'),
('35021', 'CUS1004', 'INC48528', '2018-10-23', '3444556942662', 'Microphones', 'Polycom', 'MRC63', 'Corroded. No sound ', 'Supplier Warranty', 'FM9243', '2017-04-17', 'Tech000', 'STMGR000', 'SERMGR000', 'IMPMGR000', 'New', 'Pending', 'Pending', 'Pending', 'Pending', 'Not Sent', 'Pending'),
('35022', 'CUS1004', 'INC48528', '2018-10-23', '2753479253247', 'Projectors', 'Infocus', 'S444', 'color defective', 'Supplier Warranty', 'YC4204', '2016-08-25', 'Tech000', 'STMGR000', 'SERMGR000', 'IMPMGR000', 'New', 'Pending', 'Pending', 'Pending', 'Pending', 'Not Sent', 'Pending'),
('35023', 'CUS1001', 'INC48526', '2018-10-23', '1727382481433', 'Projectors', 'Panasonic', 'PA128', 'Lamp does not start up', 'Company Warranty', 'YC4204', '2016-08-25', 'Tech000', 'STMGR000', 'SERMGR000', 'IMPMGR000', 'New', 'Pending', 'Pending', 'Pending', 'Pending', 'Not Sent', 'Pending'),
('35024', 'CUS1003', 'INC48529', '2018-10-23', '3424443712263', 'Amplifiers', 'Polycom', 'RX360', 'low gain ', 'Supplier Warranty', 'LF1643', '2017-03-18', 'Tech000', 'STMGR000', 'SERMGR000', 'IMPMGR000', 'New', 'Pending', 'Pending', 'Pending', 'Pending', 'Not Sent', 'Pending'),
('35025', 'CUS1001', 'INC48526', '2018-10-23', '1913697878929', 'Projectors', 'Panasonic', 'PA128', 'Lamp does not start up', 'Company Warranty', 'YC4204', '2016-08-25', 'Tech000', 'STMGR000', 'SERMGR000', 'IMPMGR000', 'New', 'Pending', 'Pending', 'Pending', 'Pending', 'Not Sent', 'Pending'),
('35033', 'CUS1004', 'INC48528', '2018-10-24', '1991754779732', 'Projectors', 'Panasonic', 'PA128', 'lamp defect', 'Company Warranty', 'YC4204', '2016-08-25', 'Tech000', 'STMGR000', 'SERMGR000', 'IMPMGR000', 'New', 'Pending', 'Pending', 'Pending', 'Pending', 'Not Sent', 'Pending');
...
('CUS1003', 'Rev.', 'Panadure Vijitha Nanda Thero', 'Sri Medhananda Temple,\r\nPanadura                  ', '0777961110', '0112719393', 'NA', '0112719350', 'vijithananda@gmail.com', 'active'),
('CUS1004', 'Mr.', 'Gayan Akurugoda', '25/B, Rawathawaththe,\r\nMoratuwa                                                ', '0713083182', '0112793506', '935964820V', 'NA', 'gayan@yahoo.com', 'active'),
...
--
-- Table structure for table `fdo_m_new_tbl`
--

CREATE TABLE IF NOT EXISTS `fdo_m_new_tbl` (
  `emp_id` varchar(100) NOT NULL,
  `fdo_id` varchar(100) NOT NULL,
  `fdo_first_name` varchar(100) NOT NULL,
  `fdo_last_name` varchar(100) NOT NULL,
  `fdo_gender` varchar(100) NOT NULL,
  `fdo_email` varchar(100) NOT NULL,
  `fdo_contact` varchar(100) NOT NULL,
  `fdo_nic` varchar(20) NOT NULL,
  `status` varchar(100) NOT NULL,
  PRIMARY KEY (`fdo_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(14, 'PPO', '#4609'),
(15, 'poo_history_id', 'POOH1000'),
(16, 'Job Estimate', 'JE5004');

-- --------------------------------------------------------

--
-- Table structure for table `imports_mgr_m_new_tbl`
--

CREATE TABLE IF NOT EXISTS `imports_mgr_m_new_tbl` (
  `emp_id` varchar(100) NOT NULL,
  `imp_id` varchar(100) NOT NULL,
  `imp_first_name` varchar(100) NOT NULL,
  `imp_last_name` varchar(100) NOT NULL,
  `imp_gender` varchar(100) NOT NULL,
  `imp_email` varchar(100) NOT NULL,
  `imp_contact` varchar(100) NOT NULL,
  `imp_nic` varchar(20) NOT NULL,
  `status` varchar(100) NOT NULL,
  PRIMARY KEY (`imp_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `imports_m_table`
--

INSERT INTO `imports_m_table` (`emp_id`, `ima_id`, `ima_name`, `ima_contact`, `status`) VALUES
('EMP1040', 'IMPMGR601', 'Sunimal', '0776790257', 'Active');
...
CREATE TABLE IF NOT EXISTS `job_estimate_tbl` (
  `job_estimate_id` varchar(100) NOT NULL,
  `job_id` varchar(100) NOT NULL,
  `customer_id` varchar(100) NOT NULL,
  `category` varchar(100) NOT NULL,
  `make` varchar(100) NOT NULL,
  ...
  `est_inspect_fee` double(20,2) NOT NULL,
  `all_parts_cost` double(20,2) NOT NULL,
  `parts_markup_cost` double(20,2) NOT NULL,
  `parts_markup_limit` int(3) NOT NULL,
  `total_parts_markup_cost_final` double(20,2) NOT NULL,
  `labour_cost` double(20,2) NOT NULL,
  `tax_vat` double(20,2) NOT NULL,
  `tax_nbt` double(20,2) NOT NULL,
  `tax_vat_limit` int(20) NOT NULL,
  `tax_nbt_limit` double(20,2) NOT NULL,
  `total_job_cost` double(20,2) NOT NULL,
  `est_send_date` date NOT NULL,
  `est_expire_date` date NOT NULL,
  `status` varchar(50) NOT NULL,
  `status_view` varchar(100) NOT NULL,
  PRIMARY KEY (`job_estimate_id`),
  KEY `job_id` (`job_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `job_estimate_tbl`
--

INSERT INTO `job_estimate_tbl` (`job_estimate_id`, `job_id`, `customer_id`, `category`, `make`, `model`, `serial_no`, `estimate_desc`, `est_inspect_fee`, `all_parts_cost`, `parts_markup_cost`, `parts_markup_limit`, `total_parts_markup_cost_final`, `labour_cost`, `tax_vat`, `tax_nbt`, `tax_vat_limit`, `tax_nbt_limit`, `total_job_cost`, `est_send_date`, `est_expire_date`, `status`, `status_view`) VALUES
('JE500', '35017', 'CUS10', 'Microphones', 'Polycom', 'PJ50', '3696648158963', '', 0.00, 0.00, 0.00, 0, 0.00, 0.00, 0.00, 0.00, 0, 0.00, 0.00, '0000-00-00', '0000-00-00', 'New', 'New'),
('JE5002', '35018', 'CUS1003', 'Microphones', 'Polycom', 'PJ50', '3641593518275', '', 0.00, 0.00, 0.00, 0, 0.00, 0.00, 0.00, 0.00, 0, 0.00, 0.00, '0000-00-00', '0000-00-00', 'New', 'New'),
('JE5003', '35019', 'CUS1003', 'Conference', 'Polycom', 'PTL333', '3199157456249', '', 0.00, 0.00, 0.00, 0, 0.00, 0.00, 0.00, 0.00, 0, 0.00, 0.00, '0000-00-00', '0000-00-00', 'New', 'New'),
('JE5004', '35020', 'CUS1003', 'Conference', 'Polycom', 'PTL333', '3166592719145', '', 0.00, 0.00, 0.00, 0, 0.00, 0.00, 0.00, 0.00, 0, 0.00, 0.00, '0000-00-00', '0000-00-00', 'New', 'New');
...
(55, '35015', 'TEC201', 'STMGR401', '', '', '2018-10-07', '2018-10-07', 'CUS1001', 'Supplier Warranty', 'Projectors', 'Infocus', 'S444', '2862518412789', 'Lamp not working', 'power unit ic burn', 'replace new ic', 'P_10001', '0.5A FUSE', '0.5A FUSE', '2', 'NA', '0', '0', '0', 0),
(56, '35015', 'TEC201', 'STMGR401', '', 'IMPMGR601', '2018-10-07', '2018-10-07', 'CUS1001', 'Supplier Warranty', 'Projectors', 'Infocus', 'S444', '2862518412789', 'Lamp not working', 'lamp cut off', 'replace a new lamp', 'P_10017', 'SP-LP-078', 'Lamp for IN3124/26/28HD', '1', 'NA', '0', '0', 'RMA', 0),
(60, '35017', 'TEC201', 'STMGR401', '', '', '2018-10-21', '2018-10-21', 'CUS1004', 'Customer Repair', 'Microphones', 'Polycom', 'PJ50', '3696648158963', 'Lamp not working ', 'Lamp not working', 'replace lamp power board', 'P_10004', '100maf', '100ma FUSE', '2', 'NA', '0', '0', '0', 0),
(61, '35018', 'TEC201', 'STMGR401', 'SERMGR000', 'IMPMGR000', '2018-10-23', '2018-10-23', 'CUS1003', 'Customer Repair', 'Microphones', 'Polycom', 'PJ50', '3641593518275', 'No Power ', 'Lamp  not working', 'replace IC', 'P_10010', '2.2K1/4W', '2.2K 1/4W RESISTOR', '2', 'NA', '0', '0', '0', 0),
(62, '35019', 'TEC201', 'STMGR401', 'SERMGR000', 'IMPMGR000', '2018-10-23', '2018-10-23', 'CUS1003', 'Customer Repair', 'Conference', 'Polycom', 'PTL333', '3199157456249', 'No Power', 'no power', 'replace ic', 'P_10011', '0-09-1002', 'POT 1KB DUAL CONTROL', '1', 'NA', '0', '0', '0', 0),
(63, '35020', 'TEC201', 'STMGR401', 'SERMGR000', 'IMPMGR000', '2018-10-23', '2018-10-23', 'CUS1003', 'Customer Repair', 'Conference', 'Polycom', 'PTL333', '3166592719145', 'No Power', 'no power', 'replace IC board ', 'P_10010', '2.2K1/4W', '2.2K 1/4W RESISTOR', '2', 'N A', '0', '0', '0', 0);
...
('P_10001', '0.5A FUSE', '0.5A FUSE', 5, 5, 'FUSE', '2', 14.00, 'BOX-01-22', '', '', '', 'No', 'Available', '', ''),
...
('P_10004', '100maf', '100ma FUSE', 3, 1, 'FUSE', '2', 20.00, 'BOX-01-A', '', '', '', 'No', 'Available', '', ''),
...
('P_10017', 'SP-LP-078', 'Lamp for IN3124/26/28HD', 6, 0, 'LAMP', '40500', 0.00, 'BOX-F', '', '', '', 'Yes', 'Available', '', ''),
...
('#4609', '35017', 'P_10004', '100maf', '100ma FUSE', 1, 0, 2, '', 'Pending');

-- --------------------------------------------------------

--
-- Table structure for table `pricing_info_m_tbl`
--

CREATE TABLE IF NOT EXISTS `pricing_info_m_tbl` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `pricing_info_m_tbl`
--

INSERT INTO `pricing_info_m_tbl` (`id`, `type`, `value`) VALUES
(1, 'VAT', 15.00),
(2, 'NBT', 2.00),
(3, 'Markup', 30.00);
...
INSERT INTO `rma_tbl` (`job_id`, `rma_no`, `imports_manager_id`, `category`, `make`, `model`, `serial_no`, `problem_description`, `pop_no`, `pop_date`, `supplier_id`, `supplier_name`, `address`, `email`, `phone_no`, `fax_no`, `part_ref_code`, `part_no`, `part_description`, `qty`, `service_mgr_note`, `status`) VALUES
('35015', '#RMA', 'IMPMGR601', 'Projectors', 'Infocus', 'S444', '2862518412789', 'Lamp not working', 'YC4204', '2016-08-25', 'SUP1002', 'Yon Chi', 'Panasonic Corporation,1006, Oaza Kadoma, Kadoma-shi, Osaka 571-8501, Japan.                         ', 'yonc@panasonic.lk', '+81669081121', '+81669081122', 'P_10017', 'SP-LP-078', 'Lamp for IN3124/26/28HD', 1, '', 'Pending');
...
--
-- Table structure for table `service_mgr_m_new_tbl`
--

CREATE TABLE IF NOT EXISTS `service_mgr_m_new_tbl` (
  `emp_id` varchar(100) NOT NULL,
  `ser_mgr_id` varchar(100) NOT NULL,
  `ser_mgr_first_name` varchar(100) NOT NULL,
  `ser_mgr_last_name` varchar(100) NOT NULL,
  `ser_mgr_gender` varchar(100) NOT NULL,
  `ser_mgr_email` varchar(100) NOT NULL,
  `ser_mgr_contact` varchar(100) NOT NULL,
  `ser_mgr_nic` varchar(20) NOT NULL,
  `status` varchar(100) NOT NULL,
  PRIMARY KEY (`ser_mgr_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
('SUP1012', 'Ann Froster', 'The Place, 4th Floor, 175 High Holborn, London WC1V 7AA, United Kingdom                             ', '+44 7531 949110', 'annfroster@zoom.com', '+44 7531 949111', 'Electronics', 'Zoom', 'active');

-- --------------------------------------------------------

--
-- Table structure for table `technician_m_new_tbl`
--

CREATE TABLE IF NOT EXISTS `technician_m_new_tbl` (
  `emp_id` varchar(100) NOT NULL,
  `tech_id` varchar(100) NOT NULL,
  `tech_first_name` varchar(100) NOT NULL,
  `tech_last_name` varchar(100) NOT NULL,
  `tech_gender` varchar(10) NOT NULL,
  `tech_email` varchar(100) NOT NULL,
  `tech_contact` varchar(100) NOT NULL,
  `tech_nic` varchar(20) NOT NULL,
  `status` varchar(100) NOT NULL,
  PRIMARY KEY (`tech_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `user_login_m_new_tbl`
--

CREATE TABLE IF NOT EXISTS `user_login_m_new_tbl` (
  `user_id` varchar(100) NOT NULL,
  `user_role_id` int(11) NOT NULL,
  `user_role_title` varchar(100) NOT NULL,
...
('EMP1005', 2, 'import1@abc.comrr', '2554d45d61c0b4be4e67bcd58f43ca1cee927109', '', '0', '1'),
('EMP1039', 3, 'sermagt1@abc.com', '4cf5bc59bee9e1c44c6254b5f84e7f066bd8e5fe', '', '0', '1'),
('EMP1040', 2, 'import1@abc.com', '2554d45d61c0b4be4e67bcd58f43ca1cee927109', '', '0', '1'),
