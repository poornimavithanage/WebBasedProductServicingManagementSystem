...
<html lang="en">
    ...
    <body class="padTop53 " >
        ...
        <div id="wrap">
            ...
            <div id="content">
                <div class="inner" style="min-height:1200px;">
                    <div class="row" style="margin-top: 0.5%;">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <ul class="breadcrumb">
                                ...
                                <li><a style="text-decoration: none;" href="#" class="di">Assign RMA </a></li>
                            </ul>
                        </div>
                    </div><!--/.row-->
                    ...
                    <div class="row" style="margin-top: 0.5%;">
                        <div class="col-md-2">
                            <div style="font-weight: bold; margin-left: 10%;">
                                <a href="<?php echo base_url(); ?>/index.php/imports_manager_c_view/unassigned_rma_list/" class="btn btn-round-sm btn-sm btn-danger">Go Back</a>
                            </div>
                        </div>
                    </div>


                    <div class="row <?php //if($job_repair_info[0]->imports_manager_id === $imports_manager_id){echo "hide";}else{echo "";} ?>" style="margin-top: 0.5%;">
                        <div class="col-md-12">
                            <div class="col-lg-12">
                                <hr>
                            </div>
                    ...
                    <div class="row <?php //if($job_repair_info[0]->imports_manager_id === $imports_manager_id){echo "hide";}else{echo "";} ?>" id="button_block" style="margin-top: 2%;">
                        <div class="col-md-12 col-lg-offset-5">
                            <div class="col-lg-1">
                                <button class="btn btn-success" id="assign_to_me_button" type="button">Assign to me</button>
                            </div><!-- /.col-lg-1 --> 
                        </div><!-- /.col-md-12 --> 
                    </div>
                                                            ...
                                                            foreach ($job_repair_info as $repair_info) {
                                                                ...
                                                                if ($repair_info->order_type === "RMA") {
                                                                   ...
                                                                   <input type='text' value='" . $repair_info->part_ref_code . "'  id='rma_part_ref_code" . $i . "' name='rma_part_ref_code[]' class='form-control' readonly=''/>
                                                                    ...
                                                                    <textarea placeholder='note' id='rma_note' name='rma_note[]' rows='5' cols='8' class='form-control' readonly></textarea>
                                                                </td>";
        ...
        <script>
            $(document).ready(function () {
                $("#assign_to_me_button").click(function (e) {
                    e.preventDefault();
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>index.php/imports_manager_c_view/assign_job_to_me/" + job_id,
//                        data: $("#service_manager_job_form").serialize(),
                        ...
                        success: function (data) {
                            ...
                            if (data.final_result === "success") {
                                ...
                                $("#spnmessage_2").html('<p><strong>RMA successfuly assigned to you!</strong></p>');
                                $("#divmessage_2").removeAttr("class", "hide");
                                $("#divmessage_2").fadeIn(1500);
                                $("#divmessage_2").delay(3500).fadeOut(2500);
                                setTimeout(function () {
                                    //location.reload();
                                    window.location.href = "<?php echo base_url(); ?>/index.php/imports_manager_c_view/unassigned_rma_list";
                                }, 4000);
                                ...
                                $("#spnmessage_2").html('<p><strong>Unable to assign this rma,Please contact administration!</strong></p>');
                                $("#divmessage_2").removeAttr("class", "hide");
                                $("#divmessage_2").fadeIn(1500);
