...
<!--                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            <div style="font-weight: bold; margin-left: 10%;">
                                <a href="<?php echo base_url(); ?>/index.php/technician_c_view/job_card_list_assigned_to_me_page" class="btn btn-round-sm btn-sm btn-danger">Back</a>
                            </div>
                        </div>
...
<!--                        <div class="col-sm-5 serial_check_status_block_2" style="margin-left: -9%;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form id="class_add_form" class="form-horizontal" method="POST" action="<?php echo base_url(); ?>index.php/technician_c_view/technician_job_card_form_update">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach ($job_repair_info as $repair_info) {
                                                                ...
                                                                echo "<td data-id='actual_defect'>
                                                                    <textarea placeholder='Actual Defect' id='actual_defect" . $i . "' name='actual_defect[]' rows='3' cols='5' class='form-control actual_defect' >" . $repair_info->actual_defect . "</textarea>
                                                                        </td>";

                                                                echo "<td data-id='solution'>
                                                                    <textarea placeholder='Solution' id='solution" . $i . "' name='solution[]' rows='3' cols='5' class='form-control solution' >" . $repair_info->solution . "</textarea>
                                                                    </td>";
...
//                                                                    </td>";
                                                                ...
                                                                echo "<td data-id='qty'>
                                                                    <input type='number' id='qty" . $i . "' name='qty[]' class='form-control qty' placeholder='0' value='" . $repair_info->qty . "'/>
                                                                    </td>";

                                                                echo "<td data-id='remarks'>
                                                                    <textarea placeholder='Remarks' id='remarks" . $i . "' name='remarks[]' rows='3' cols='5' class='form-control remarks'>" . $repair_info->remarks . "</textarea>
                                                                    </td>";
