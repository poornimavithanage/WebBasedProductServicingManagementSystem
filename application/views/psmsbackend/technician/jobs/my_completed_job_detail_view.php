                    ...
                    <div class="row" style="margin-top: 0.5%;">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <ul class="breadcrumb">
                                ...
                                <li><a style="text-decoration: none;" href="#" class="di">My Completed Job</a></li>
                            </ul>
                        </div>
                    </div><!--/.row-->
                    ...
                    <div class="row" style="margin-top: 0.5%;">
                        <div class="col-md-2">
                            <div style="font-weight: bold; margin-left: 10%;">
                                <a href="<?php echo base_url(); ?>index.php/technician_c_view/my_completed_job_list" class="btn btn-round-sm btn-sm btn-warning">Go Back</a>
                            </div>
                        </div>
                    </div>
