                    ...
                    <div class="row" style="margin-top: 0.5%;">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <ul class="breadcrumb">
                                ...
                                <li><a style="text-decoration: none;" href="#" class="di">Store Parts Received Jobs</a></li>
                            </ul>
                        </div>
                    </div><!--/.row-->

                    <div class="row <?php if ($page_msg === "unsuccess") {echo "";} else { echo "hide";} ?>" id="pg_msg">
                        <div class="container-fluid">
                            <div class="col-md-12" id="divmessage_3">
                                <div id="spnmessage_3" class="alert alert-warning alert-dismissible" role="alert">
                                    <strong>Unable to change the status,  Please contact administrator!</strong> 
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="panel with-nav-tabs panel-default">
                                    <div class="panel panel-primary">
                                        <div class="panel-heading">
                                            <ul class="nav nav-tabs">
                                                <strong>Store Parts Received Jobs</strong>
                                            </ul>
                                        </div></div>
                                    <div class="panel-body" >
                                        <table id="table1" class="table table-striped table-bordered table-list dataTables-example">
                                            ...
                                            <tbody>
                                                <?php
                                                foreach ($store_parts_recieved_list as $act_job) {
                                                    ...
                                                    echo "<td>" . $act_job->current_status . "</td>";
                                                    echo "<td>";
                                                    echo "<a href='" . base_url() . "/index.php/technician_c_view/technician_wip?var1=" . $act_job->job_id . "&var2=" . $tech_id . "' class='btn btn-success btn-xs'><i class='icon-briefcase'></i>&nbsp;Technician WIP</a>&nbsp; &nbsp";
                                                    echo "<a href='" . base_url() . "/index.php/technician_c_view/job_assigned_to_me_detail_view/" . $act_job->job_id . "' class='btn btn-warning btn-xs'><i class='icon-external-link'></i>&nbsp;View</a>&nbsp; &nbsp";
                                                    echo "</tr>";
                                                }
                                                ?>
                                            </tbody>
