                    ...
                    <div class="row" style="margin-top: 0.5%;">
                        <div class="col-md-2">
                            <div style="font-weight: bold; margin-left: 10%;">
                                <a href="<?php echo base_url(); ?>/index.php/supplier_c/add_supplier_page" class="btn btn-round-sm btn-sm btn-primary">Add Supplier</a>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <table id="table1" class="table table-striped table-bordered table-list dataTables-example">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($active_suppliers as $act_sup) {
                                                            ...
                                                            echo "<a href='". base_url()."/index.php/supplier_c/supplier_detail_view/".$act_sup->supp_id."' class='btn btn-info btn-xs'><i class='icon-external-link'></i>&nbsp;View</a>&nbsp; &nbsp;";
                                                            echo "</td>";
                                                            echo "</tr>";
                                                        }
                                                        ?>
       ...
       <!-- **** Below two JS Scripts handles the remove function **** -->
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#removeSupplierModalForm").submit(function (e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>index.php/supplier_c/remove_suppliers",
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#restoreSupplierModalForm").submit(function (e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: baseurl + "index.php/supplier_c/restore_suppliers",
        ...
        <script>
            $(".editSupplier").click(function () {
                ...
                if (s_id !== null) {
                    $("#edit_yes").attr('href','<?php echo base_url();?>/index.php/supplier_c/edit_suppliers_page/'+s_id);
