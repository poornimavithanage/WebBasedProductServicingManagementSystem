...
<!--                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            <div style="font-weight: bold; margin-left: 10%;">
                                <a href="<?php echo base_url(); ?>/index.php/billing_c/import_bill_data_page" class="btn btn-round-sm btn-sm btn-success">Import bill from CSV</a>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <table id="table1" class="table table-striped table-bordered table-list dataTables-example">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($all_bill_list as $bill_all_list) {
                                                            ...
                                                            echo "<td>";
                                                            echo "<a href='". base_url()."/index.php/billing_c/view_invoice_details/".$bill_all_list->invoice_no."' class='btn btn-info btn-xs'><i class='icon-external-link'></i>&nbsp;View</a>&nbsp; &nbsp;";
                                                            echo "</td>";
                                                            echo "</tr>";
