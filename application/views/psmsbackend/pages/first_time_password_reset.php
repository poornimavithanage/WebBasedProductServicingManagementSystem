        ...
        <div class="container">
            ...
            <div class="tab-content">
                <div id="login" class="tab-pane active">
                    <form id="first_time_password_reset" action="<?php echo base_url(); ?>index.php/login_c/first_time_password_reset" class="form-signin" method="POST">
                        
                        <div style="margin-left: 24%; margin-top: 4%;"><strong>First time password reset</strong></div>
                        <input type="text" id="username" name="username" value="<?php echo $username; ?>" class="form-control" readonly=""/>
                        <input type="text" id="old_password" name="old_password" value="<?php echo $password; ?>" class="form-control hide" readonly=""/>
                        <input type="password" id="new_password" name="new_password" placeholder="New Password" class="form-control" />
                        <input type="password" id="confirm_password" name="confirm_password" placeholder="Retype Password" class="form-control" />
