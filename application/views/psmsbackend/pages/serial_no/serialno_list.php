                    ...
                    <div class="row" style="margin-top: 0.5%;">
                        <div class="col-md-2">
                            <div style="font-weight: bold; margin-left: 10%;">
                                <a href="<?php echo base_url(); ?>/index.php/serialno_c/add_serial_nos_page_sales_order_search" class="btn btn-round-sm btn-sm btn-primary">Add serial no</a>
                            </div>
                        </div>
                    </div>
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#removeSerialnoModalForm").submit(function (e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: baseurl + "index.php/serialno_c/remove_serial_nos",
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#restoreSerialnoModalForm").submit(function (e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: baseurl + "index.php/serialno_c/restore_serial_nos",
