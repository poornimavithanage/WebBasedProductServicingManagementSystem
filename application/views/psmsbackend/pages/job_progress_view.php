...
<html lang="en">
    ...
    <body class="padTop53 " >
                    ...
                    <div class="row" style="margin-top: 0.5%;">
                        <div class="col-md-2">
                            <div style="font-weight: bold; margin-left: 10%;">
                                <input data-toggle="modal" data-target="#add_products" type="button" class="btn btn-primary btn-round-md btn-md" value="Add Products"/>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <table id="table1" class="table table-striped table-bordered table-list dataTables-example">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($active_products as $act_pro) {
                                                            ...
                                                            echo "<a id='" . $act_pro->item_product_m_id . "' href='#editProductModal' data-toggle='modal' class='editProduct btn btn-warning btn-xs'><i class='icon-edit'></i>&nbsp;Edit</a>";
                                                            echo "</td>";
                                                            echo "</tr>";
                                                        }
                                                        ?>
        ...
        <!-- add product modal -->
        <div class="modal fade" id="add_products" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true">
