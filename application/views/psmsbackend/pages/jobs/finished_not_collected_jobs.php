                                        ...
                                        <table id="table1" class="table table-striped table-bordered table-list dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($finished_not_collected_list as $list) {
                                                    ...
                                                    echo "<td>";
                                                    echo "<a href='" . base_url() . "index.php/jobentry_c/view_job_finished_not_collected?var1=" . $list->job_id . "' class='btn btn-success btn-xs'><i class='icon-briefcase'></i>&nbsp;View</a>&nbsp; &nbsp";
                                                    echo "<a href='" . base_url() . "index.php/jobentry_c/send_sms_finished_not_collected/" . $list->job_id . "' class='btn btn-warning btn-xs'><i class='icon-external-link'></i>&nbsp;Send SMS</a>&nbsp; &nbsp";
                                                    echo "</tr>";
                                                }
                                                ?>
                                            </tbody>
