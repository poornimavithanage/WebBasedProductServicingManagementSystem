                                        ...
                                        <table id="table1" class="table table-striped table-bordered table-list dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($job_estimations as $list) {
                                                    ...
                                                    echo "<td>";
                                                    echo "<a href='" . base_url() . "index.php/jobentry_c/view_job_estimation_detail_page?var1=" . $list->job_id . "' class='btn btn-success btn-xs'><i class='icon-briefcase'></i>&nbsp;View</a>&nbsp; &nbsp";
                                                    echo "</tr>";
                                                }
                                                ?>
                                            </tbody>
