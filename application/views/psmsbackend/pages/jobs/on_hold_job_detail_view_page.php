            ...
            <div id="content">
                <div class="inner" style="min-height:1200px;">
                    ...
                    <div class="row" style="margin-top: 0.5%;">
                        <div class="col-md-2">
                            <div style="font-weight: bold; margin-left: 10%;">
                                <a href="<?php echo base_url(); ?>index.php/jobentry_c/on_hold_jobs_list" class="btn btn-round-sm btn-sm btn-warning">Go Back</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <form id="reject_status_form" class="form-horizontal" method="POST" action="">
                                <div class="row" style="margin-left: -0.5%;">
                                    <div class="col-md-12">
                                        <div class="col-md-2 hide">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6" style="">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="reject_status" name="reject_status" >                                                
                                                    <option disabled selected value> - select status no - </option>
                                                    <option value="Company Reject">Company Reject</option>
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#send_onhold_job_sms_form").submit(function (e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: baseurl + "index.php/jobentry_c/send_on_hold_job_sms",
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#reject_status_form").submit(function (e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: baseurl + "index.php/jobentry_c/reject_status_update",
