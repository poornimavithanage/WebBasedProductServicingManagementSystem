...
<html lang="en">
                    ...
                    <div class="row" style="margin-top: 0.5%;">
                        <div class="col-md-2">
                            <div style="font-weight: bold; margin-left: 10%;">
                                <a href="<?php echo base_url(); ?>/index.php/customer_c/add_customer_page" class="btn btn-round-sm btn-sm btn-primary">Add Customer</a>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <table id="table1" class="table table-striped table-bordered table-list dataTables-example">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($active_customers as $act_cus) {
                                                            ...
                                                            echo "<td>";
                                                            echo "<a id='" . $act_cus->customer_id . "' href='#remove_confirmation_modal' data-toggle='modal' class='removeCustomer btn btn-danger btn-xs'><i class='icon-remove-circle'></i>&nbsp;Remove</a>&nbsp; &nbsp;";
                                                            ...
                                                            echo "<a href='". base_url()."/index.php/customer_c/customer_detail_view/".$act_cus->customer_id."' class='btn btn-info btn-xs'><i class='icon-external-link'></i>&nbsp;View</a>&nbsp; &nbsp;";
                                                            echo "</td>";
                                                            echo "</tr>";
                                                        }
                                                        ?>
                                                ...
                                                <table id="table1" class="table table-striped table-bordered table-list dataTables-example">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($deactive_customers as $deact_cus) {
                                                            ...
                                                            echo "<td>";
                                                            echo "<a id='" . $deact_cus->customer_id . "' href='#restore_confirmation_modal' data-toggle='modal' class='restoreCustomer btn btn-warning btn-xs'><i class='icon-remove-circle'></i>&nbsp;Restore</a>&nbsp; &nbsp;";
                                                            echo "</td>";
                                                            echo "</tr>";
                                                        }
                                                        ?>
    ...
    <!-- remove customer confirmation modal -->
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#removeCustomerModalForm").submit(function (e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: baseurl + "index.php/customer_c/remove_customers",
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#restoreCustomerModalForm").submit(function (e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: baseurl + "index.php/customer_c/restore_customers",
        ...
        <!-- <script>
            $(".restoreCustomer").click(function () {
                ...
                $.ajax({
                        type: "POST",
                        url: baseurl + "index.php/customer_c/get_customer_details",
                        data: {'customer_id_for_edit':c_id},
                        dataType: 'json',
                        success: function (data) {
                            //console.log(data);
                            if (data.final_result === "success") {
    ...
    <script>
            $(".editCustomer").click(function () {
                ...
                if (c_id !== null) {
                    $("#edit_yes").attr('href','<?php echo base_url();?>/index.php/customer_c/edit_customers_page/'+c_id);
