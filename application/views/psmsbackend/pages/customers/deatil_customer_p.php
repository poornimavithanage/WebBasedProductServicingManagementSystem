                            ...
                            <div class="col-md-12">
                                <div class="panel with-nav-tabs panel-primary">
                                    <div class="panel-heading">
                                        ...
                                        <strong>Customer Job List</strong>
                                                ...
                                                <div class=" col-md-12 col-lg-12 "> 
                                                  <table class="table table-user-information table-striped table-bordered table-list dataTables-example">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php
                                                        foreach ($cus_job_details as $customer_job_detail) {

                                                            echo "<tr>";
                                                            echo "<td>" . $customer_job_detail->job_id . "</td>";
                                                            echo "<td>" . $customer_job_detail->job_date . "</td>";
                                                            echo "<td>" . $customer_job_detail->warranty_type . "</td>";
                                                            echo "<td>" . $customer_job_detail->current_status . "</td>";
