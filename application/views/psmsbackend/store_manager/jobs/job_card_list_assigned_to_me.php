        ...
        <div id="wrap">
            ...
            <div id="content">
                <div class="inner" style="min-height:1200px;">
                    ...
                    <div class="row <?php
                    if ($page_msg === "sent_to_store_manager") {
                        echo "";
                    } else {
                        echo "hide";
                    }
                                        ...
                                        <table id="table1" class="table table-striped table-bordered table-list dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($assigned_to_me_job_list as $assigned_jobs) {
                                                    ...
                                                    echo "<td>";
                                                    if ($assigned_jobs->current_status === "Estimation Rejected" || $assigned_jobs->store_manager_status === "Sent to Technician") {   
                                                        echo "<a href='" . base_url() . "/index.php/store_mgr_c_view/view_job_detail_page?var1=" . $assigned_jobs->job_id . "' class='btn btn-warning btn-xs'><i class='icon-external-link'></i>&nbsp;View</a>&nbsp; &nbsp";
                                                    } else if($assigned_jobs->current_status === "Estimation Approved"){
                                                         echo "<a href='" . base_url() . "/index.php/store_mgr_c_view/estimation_approved_form_load_page/" . $assigned_jobs->job_id . "' class='btn btn-warning btn-xs'><i class='icon-external-link'></i>&nbsp;View</a>&nbsp; &nbsp";
                                                    }else {
                                                        echo "<a href='" . base_url() . "/index.php/store_mgr_c_view/load_store_mgr_job_form_page_method/" . $assigned_jobs->job_id . "' class='btn btn-success btn-xs'><i class='icon-briefcase'></i>&nbsp;Update Job Card</a>&nbsp; &nbsp";
                                                    }
