                                                            ...
                                                            <?php
                                                                ...
                                                                foreach ($job_repair_info as $repair_info) {
                                                                   ...
                                                                   echo "<tr id='addr".$i ."' data-id='".$i."' class=''>";
                                                                    ...
                                                                    <select class='select_picker part_no' id='part_no".$i."' name='part_no[]' data-live-search='true' disabled> 
                                                                        <option value='".$repair_info->part_no."'>".$repair_info->part_no."</option>
                                                                    </select>
                                                                    </td>";
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $("#edit_button").on("click", function (){
                    ...
                    $(".part_no").removeAttr("disabled",true);
