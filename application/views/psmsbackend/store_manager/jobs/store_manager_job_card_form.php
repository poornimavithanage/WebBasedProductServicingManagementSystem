...
<html lang="en">
            ...
            <div id="content">
                <div class="inner" style="min-height:1200px;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form id="<?php
                            if ($job_info[0]->warranty_type === "Customer Repair") {
                                echo "send_for_estimation_form";
                            } else if ($job_info[0]->warranty_type === "Company Warranty") {
                                echo "company_repair_form";
                            }
                                ...
                                <div class="row" id="button_block">
                                    <div class="col-md-12 col-lg-offset-3">
                                        <div class="col-lg-1">
                                            ...
                                            $notAvailableCount = 0;
                                            foreach ($job_repair_info as $repair_info) {
                                                if ($repair_info->store_qty < $repair_info->qty && $repair_info->store_qty != 0 || ($repair_info->store_qty == 0)) {
                                                    $notAvailableCount +=1;
                                                } else {
                                                    $availabeCount +=1;
                                                }
                                            ...
                                            if (count($job_repair_info) === $availabeCount) {

                                                echo '<button class = "btn btn-primary" id = "" type = "submit">';
                                                if ($job_info[0]->warranty_type === "Customer Repair") {
                                                    echo "Send for Estimate";
                                                } else if ($job_info[0]->warranty_type === "Company Warranty") {
                                                    echo "Send to Teachnician";
                                                }
                                                echo '</button>';
                                            }
                                            ?>
                    ...
                    if (count($job_repair_info) != $availabeCount) {
                       ...
                       echo '<div class="row">';
                        echo '<div class="col-md-12">';
                            echo '<form id="on_hold_form" class="form-horizontal" method="POST" action="">';
                                echo '<div class="row" style="margin-top: 1%;">';
                                    echo '<div class="col-md-12">';
                                        echo '<div class="col-lg-12">';
                                            echo '<div class="panel panel-default">';
                                                echo '<div class="panel-heading">';
                                                    echo '<strong>On Hold Job</strong>';
                                                echo '</div>';
                                                echo '<div class="panel-body" >';

                                                    echo '<div class="row">';
                                                    echo '<div class="col-md-3 hide" style="margin-left:3%">';
                                                            echo '<div class="form-group">';
                                                                echo '<label for="job_id">Job No</label>';
                                                                echo '<input type="text" class="form-control" id="job_id" name="job_id" placeholder="Job Id" required="" readonly="" value="'.$job_info[0]->job_id .'">';
                                                            echo '</div>';
                                                        echo '</div>';
                                                        echo '<div class="col-md-3 hide" style="margin-left:3%">';
                                                            echo '<div class="form-group">';
                                                                echo '<label for="customer_id">Customer No</label>';
                                                                echo '<input type="text" class="form-control" id="customer_id" name="customer_id" required="" readonly="" value="'. $job_info[0]->customer_id .'">';
                                                            echo '</div>';
                                                        echo '</div>';
                                                        echo '<div class="col-md-3" style="margin-left:3%">';
                                                            echo '<div class="form-group">';
                                                                echo '<label for="onhold_note">On Hold Note </label>';
                                                                echo '<select name="onhold_note" id="onhold_note" class="form-control" >';
                                                                    echo '<option value="" disabled selected>select on hold note </option>';
                                                                    echo '<option value="Parts Not Available">Parts Not Available </option>';
                                                                    echo '<option value="Other">Other </option>';
                                                                echo '</select>';
                                                            echo '</div>';
                                                        echo '</div>';
                                                        echo '<div id="onhold_note_2_block" class="col-md-3 hide" style="margin-left: 3%">';
                                                            echo '<div class="form-group">';
                                                                echo '<label for="onhold_note_2">On Hold Note </label>';
                                                                echo '<textarea placeholder="Onhold Note" id="onhold_note_2" name="onhold_note_2" cols="5" class="form-control"></textarea>';
                                                            echo '</div>';
                                                        echo '</div>';
                                                        echo '<div id="onhold_note_2_block" class="col-md-3" style="margin-left: 3%; margin-top: 2.0%;">';
                                                            echo '<div class="form-group">';
                                                                echo '<button class = "btn btn-primary" id = "" type = "submit">Submit</button>';
                                                            echo '</div>';
                                                        echo '</div>';
                                                    echo '</div>';
    ...
    <script type="text/javascript">
            $(document).ready(function () {
                ...
                $('#onhold_note').on('change', function () {
                    var onhold_note = this.value;
                    if (onhold_note === "Other") {

                        $("#onhold_note_2_block").removeAttr('class');
                        $("#onhold_note_2_block").attr('class', 'col-md-3');
                    } else {

                        $("#onhold_note_2_block").attr('class', 'col-md-3 hide');
                    }
    ...
    <script>
        $(document).ready(function () {
            $("#store_manager_job_form").validate({
                rules: {
                    onhold_note: {
                        required: true
                    },
                    onhold_note_2: {
                        required: function () {
                            return $('#onhold_note').val() === "Other";
                        }
                    },
                    messages: {
                        onhold_note: {
                            required: "Please select onhold reason"
                        },
                        onhold_note_2: {
                            required: "Please type the onhold reason"
                        }
                    }
    ...
    <!-- On Hold Status update form if one or more parts are not available -->
    <script>
        $(document).ready(function () {
            ...
            $("#on_hold_form").submit(function (e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>index.php/store_mgr_c_view/onholdForm",
                    data: $("#on_hold_form").serialize(),
                    dataType: 'json',
    ...
    <script>
        $(document).ready(function () {
            baseurl = "http://localhost/psms/";
            $("#send_for_estimation_form").submit(function (e) {
                e.preventDefault();
                if (!$(this).valid())
                    return false;
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>index.php/store_mgr_c_view/job_estimate_submit",
                    data: $("#send_for_estimation_form").serialize(),
                    dataType: 'json',
                    success: function (data) {
                        //                            console.log(data);
                        if (data.final_result === "success") {
                            ...
                            $("#spnmessage_1").html('<p><strong>Job send for the Estimation</strong></p>');
                            ...
                            $("#spnmessage_1").html('<p><strong>Unable to send for Estimation, please contact administrator, thank you!</strong></p>');
                            $("#divmessage_1").removeAttr("class", "hide");
                            $("#divmessage_1").fadeIn(1500);
    ...
    <!--If Job warranty type is Company Repair-->
    <script>
        $(document).ready(function () {
            baseurl = "http://localhost/psms/";
            $("#company_repair_form").submit(function (e) {
                e.preventDefault();
                if (!$(this).valid())
                    return false;
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>index.php/store_mgr_c_view/company_repair_form_submit",
                    data: $("#company_repair_form").serialize(),
                    dataType: 'json',
                    success: function (data) {
                        //                            console.log(data);
                        if (data.final_result === "success") {
