                    ...
                    <div class="row" style="margin-top: 0.5%;">
                        <div class="col-md-2">
                            <div style="font-weight: bold; margin-left: 10%;">
                                <div style="font-weight: bold; margin-left: 10%;">
                                    <a href="<?php echo base_url(); ?>/index.php/login_c/dashboard_fornt_desk" class="btn btn-round-sm btn-sm btn-danger">Go Back</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script>
            $(document).ready(function () {
                $("#getstockcategoryform").submit(function (e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>index.php/front_desk_c_view/get_the_stock_inventory_data",
                        ...
                        success: function (data) {
                            ...
                            if (data.final_result === "success") {
                                ...
                                setTimeout(function () {
                                    window.open('<?php echo base_url(); ?>index.php/front_desk_c_view/generate_stock_inventory_category_pdf?var1=' + data.category , '_blank');
                                }, 5000);
        ...
        <script>
            $(document).ready(function () {
                $("#getstockqtyform").submit(function (e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>index.php/front_desk_c_view/get_the_stock_inventory_qty_data",
                        ...
                        success: function (data) {
                            ...
                            if (data.final_result === "success") {
                                ...
                                setTimeout(function () {
                                    window.open('<?php echo base_url(); ?>index.php/front_desk_c_view/generate_stock_qty_pdf?var1=' + data.qty , '_blank');
                                }, 5000);
                            } else if (data.final_result === "unsuccess") {
                                $("#spnmessage").removeAttr("class", "alert alert-success");
                                $("#spnmessage").attr("class", "alert alert-danger");
