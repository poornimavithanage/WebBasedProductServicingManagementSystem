        ...
        <script>
            $(document).ready(function () {
                $("#getjobstatusform").submit(function (e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>index.php/front_desk_c_view/get_the_report_data",
                        ...
                        success: function (data) {
                            ...
                            if (data.final_result === "success") {
                                ...
                                setTimeout(function () {
                                    window.open('<?php echo base_url(); ?>index.php/front_desk_c_view/generate_report_pdf?var1=' + data.from +'&var2=' + data.to + '&var3=' + data.status , '_blank');
                                }, 5000);
