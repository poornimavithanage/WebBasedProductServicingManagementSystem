...
<!--                        <div class="col-md-2">
                            <div style="font-weight: bold; margin-left: 10%;">
                                <a href="<?php echo base_url(); ?>/index.php/front_desk_c_view/parts_inventory_add_page" class="btn btn-round-sm btn-sm btn-primary">Add new parts</a>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div style="font-weight: bold; margin-left: -45%;">
                                <a href="<?php echo base_url(); ?>/index.php/front_desk_c_view/parts_inventory_update_page" class="btn btn-round-sm btn-sm btn-warning">Update inventory</a>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div style="font-weight: bold; margin-left: 10%;">
                                <a href="<?php echo base_url(); ?>/index.php/front_desk_c_view/import_stock_inventory_data_page" class="btn btn-round-sm btn-sm btn-success">Import stock inventory from CSV</a>
                            </div>
                        </div>
                    </div>-->
...
//                                                            echo "<td>";
//                                                            echo "<a href='". base_url()."/index.php/front_desk_c_view/view_part_details/".$part_all_list->part_ref_code."' class='btn btn-info btn-xs'><i class='icon-external-link'></i>&nbsp;View</a>&nbsp; &nbsp;";
//                                                            echo "</td>";
                                                            echo "</tr>";
                                                        }
                                                        ?>
