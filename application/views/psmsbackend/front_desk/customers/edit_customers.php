        ...
        <script>
            $(document).ready(function () {
                ...
                $("#editcustomerform").submit(function (e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>index.php/front_desk_c_view/edit_customers",
                        ...
                        success: function (data) {
                            ...
                            if (data.final_result === "success") {
                                ...
                                $("#spnmessage").html('<p><strong>Customer details changes was successful!</strong></p>');
                                $("#divmessage").removeAttr("class", "hide");
                                $("#divmessage").fadeIn(1500);
                                $("#divmessage").delay(3500).fadeOut(2500);
                                setTimeout(function () {
                                    //location.reload();
                                    window.location.href = "<?php echo base_url(); ?>/index.php/front_desk_c_view/customer_view";
                                }, 5000);
