                ...
                <div class="inner" style="min-height:1200px;">
                    ...
                    <div class="row" style="margin-top: 0.5%;">
                        <div class="col-md-2">
                            <div style="font-weight: bold; margin-left: 10%;">
                               <div style="font-weight: bold; margin-left: 10%;">
                                <a href="<?php echo base_url(); ?>/index.php/front_desk_c_view/supplier_purchase_view" class="btn btn-round-sm btn-sm btn-danger">Go Back</a>
                            </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row" style="margin-left: 1%">
                        <div class="col-md-12 well well-sm" style="width: 98%;">
                            <div style="font-weight: bold; margin-left: -10%;">
                               <div style="font-weight: bold; margin-left: 10%;">
                                <a href="<?php echo base_url(); ?>/index.php/front_desk_c_view/add_supplier_purchase_page_new" class="btn btn-round-sm btn-sm btn-primary">Add new purchase</a>
                                <a href="<?php echo base_url(); ?>/index.php/front_desk_c_view/add_supplier_purchase_page_exsisting" class="btn btn-round-sm btn-sm btn-warning">Add existing purchase</a>
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#addsupplierwarrantyform").submit(function (e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: baseurl + "index.php/front_desk_c_view/add_supplier_purchase_new",                        
                        processData: false,
                        contentType: false,
