                    ...
                    <div class="row" style="margin-top: 0.5%;">
                        <div class="col-md-2">
                            <div style="font-weight: bold; margin-left: 10%;">
                                <a href="<?php echo base_url(); ?>/index.php/front_desk_c_view/add_supplier_purchase_page_new" class="btn btn-round-sm btn-sm btn-primary">Add Supplier Purchase</a>
                            </div>
                        </div>
                    </div>
...
//                                                            echo "<td>" . $act_supwarr->warranty_applicability . "</td>";
                                                          ...
                                                          //  echo "<a id='" . $act_supwarr->supplier_purchase_id . "' href='#edit_confirmation_modal' data-toggle='modal' class='editSupplierWarranty btn btn-warning btn-xs' style='margin-right: 5%;'><i class='icon-edit'></i>&nbsp;Edit</a>";
                                                            echo "<a href='". base_url()."/index.php/front_desk_c_view/supplier_purchase_detail_view/".$act_supwarr->supplier_purchase_id."' class='btn btn-info btn-xs'><i class='icon-external-link'></i>&nbsp;View</a>&nbsp; &nbsp;";
                                                            echo "</td>";
                                                            echo "</tr>";
                                                        }
                                                        ?>
        ...
        <script>
            $(".editSupplierWarranty").click(function () {
                ...
                if (sw_id !== null) {
                    $("#edit_yes").attr('href','<?php echo base_url();?>/index.php/front_desk_c_view/edit_supplier_purchase_page/'+sw_id);
