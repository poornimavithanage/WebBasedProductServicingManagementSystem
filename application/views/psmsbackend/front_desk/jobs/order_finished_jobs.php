                                ...
                                <div class="panel with-nav-tabs panel-default">
                                    ...
                                    <div class="panel-body" >
                                        <table id="table1" class="table table-striped table-bordered table-list dataTables-example">
                                            ...
                                            <tbody>
                                                <?php
                                                foreach ($order_finished_list as $list) {
                                                    ...
                                                    echo "<td>";
                                                    echo "<a href='" . base_url() . "index.php/front_desk_c_view/view_job_order_finished?var1=" . $list->job_id . "' class='btn btn-success btn-xs'><i class='icon-briefcase'></i>&nbsp;View</a>&nbsp; &nbsp";
                                                    echo "</tr>";
                                                }
                                                ?>
                                                <?php
                                                foreach ($order_finished_estimation_reject_paid_list as $list) {
