                    ...
                    <div class="row" style="margin-top: 0.5%;">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <ul class="breadcrumb">
                                ...
                                <li><a style="text-decoration: none;" href="#" class="di">Rejected Jobs</a></li>
                            </ul>
                        </div>
                    </div><!--/.row-->
                                        ...
                                        <table id="table1" class="table table-striped table-bordered table-list dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($job_reject as $list) {
                                                    ...
                                                    echo "<td>";
                                                    echo "<a href='" . base_url() . "index.php/front_desk_c_view/view_reject_detail_page?var1=" . $list->job_id . "' class='btn btn-success btn-xs'><i class='icon-briefcase'></i>&nbsp;View</a>&nbsp; &nbsp";
                                                    echo "</td>";
                                                    echo "</tr>";
                                                }
                                                ?>
                                                <?php
                                                foreach ($job_reject_est as $list) {
