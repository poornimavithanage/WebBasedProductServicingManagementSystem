                ...
                <div class="inner" style="min-height:1200px;">
                    ...
                    <div class="row" style="margin-top: 0.5%;">
                        <div class="col-md-2">
                            <div style="font-weight: bold; margin-left: 10%;">
                                <a href="<?php echo base_url(); ?>/index.php/front_desk_c_view/jobentry_view" class="btn btn-round-sm btn-sm btn-danger">Go Back</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row" style="margin-left: 1%">
                        <div class="col-md-12 well well-sm" style="width: 98%;">
                            <form class="form-inline" id="search_cus_for_job" method="POST" action="<?php echo base_url(); ?>index.php/front_desk_c_view/load_add_job_with_customer">
                                ...
                                <tbody>
                                    <?php
                                        foreach ($active_job_cus as $job_cus) {
                                            ...
                                            echo "<td>";
                                            echo "<a href='". base_url()."/index.php/front_desk_c_view/add_job_card_page?var1=".$job_cus->customer_id."&var2=".$job_cus->invoice_no."&var3=".$job_cus->invoice_date."' class='btn btn-primary btn-xs'><i class='icon-external-link'></i>&nbsp;Create Job</a>&nbsp; &nbsp";
                                            echo "</td>";
                                            echo "</tr>";
                                        }
                                        ?>
