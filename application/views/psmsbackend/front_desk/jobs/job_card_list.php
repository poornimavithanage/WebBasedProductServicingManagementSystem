                    ...
                    <div class="row" style="margin-top: 0.5%;">
                        <div class="col-md-2">
                            <div style="font-weight: bold; margin-left: 10%;">
                                <a href="<?php echo base_url(); ?>/index.php/front_desk_c_view/add_jobs_page_cus_search" class="btn btn-round-sm btn-sm btn-primary">Add Job</a>
                            </div>
                        </div>
                    </div>
...
//                                                            echo "<a id='" . $act_job->job_id . "' href='#editJobModal' data-toggle='modal' class='editJob btn btn-success btn-xs'><i class='icon-edit'></i>&nbsp;Edit</a>";
                                                            echo "<a href='". base_url()."/index.php/front_desk_c_view/generate_job_card/".$act_job->job_id."' class='btn btn-danger btn-xs'><i class='icon-file'></i>&nbsp;PDF</a>&nbsp; &nbsp;";
                                                            echo "</td>";
                                                            echo "</tr>";
                                                        }
                                                        ?>
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#removeJobModalForm").submit(function (e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: baseurl + "index.php/front_desk_c_view/remove_jobs",
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#restoreJobModalForm").submit(function (e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: baseurl + "index.php/front_desk_c_view/restore_jobs",
        ...
        <script>
            $(".restoreJob").click(function () {
                ...
                $.ajax({
                        type: "POST",
                        url: baseurl + "index.php/front_desk_c_view/get_job_details",
