                    ...
                    <div class="row" style="margin-top: 0.5%;">
                        <div class="col-md-2">
                            <div style="font-weight: bold; margin-left: 10%;">
                                <a href="<?php echo base_url(); ?>index.php/front_desk_c_view/finished_not_collected_list" class="btn btn-round-sm btn-sm btn-warning">Go Back</a>
                            </div>
                        </div>

                        <div class="col-md-2">
                            <div style="font-weight: bold; margin-left: 457%;">
                                <a href="<?php echo base_url(); ?>index.php/front_desk_c_view/send_sms_finished_not_collected/<?php echo $job_repair_info[0]->job_id; ?>" class="btn btn-round-sm btn-sm btn-success">Send SMS</a>
                            </div>
                        </div>

                        <div class="col-md-2 <?php if($job_info[0]->sms_status === "Not Sent"){echo "hide";}else{echo"";}?>">
                            <div style="font-weight: bold; margin-left: 386%;">
                                <a href="<?php echo base_url(); ?>index.php/front_desk_c_view/order_finished/<?php echo $job_repair_info[0]->job_id; ?>" class="btn btn-round-sm btn-sm btn-danger">Order Finished</a>
                            </div>
                        </div>    
                    </div>
