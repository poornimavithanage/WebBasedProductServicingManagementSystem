                    ...
                    <div class="row" style="margin-top: 0.5%;">
                        <div class="col-md-2">
                            <div style="font-weight: bold; margin-left: 10%;">
                                <a href="<?php echo base_url(); ?>index.php/front_desk_c_view/job_estimation_list" class="btn btn-round-sm btn-sm btn-warning">Go Back</a>
                            </div>
                        </div>
                    </div>
        ...
        <script>
            $(document).ready(function () {
                $("#job_estimation_payment_form").submit(function (e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>index.php/front_desk_c_view/payment_status_update_job_estimation",
                        ...
                        success: function (data) {
                            ...
                            if (data.final_result === "success") {
                                ...
                                setTimeout(function () {
                                    //location.reload();
                                    window.location.href = "<?php echo base_url(); ?>/index.php/front_desk_c_view/job_estimation_list";
                                }, 5000);
