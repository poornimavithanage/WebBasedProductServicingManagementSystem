            ...
            <div id="content">
                <div class="inner" style="min-height:1200px;">
                    ...
                    <div class="row" style="margin-top: 0.5%;">
                        <div class="col-md-2">
                            <div style="font-weight: bold; margin-left: 10%;">
                                <a href="<?php echo base_url(); ?>/index.php/front_desk_c_view/add_jobs_page_cus_search" class="btn btn-round-sm btn-sm btn-danger">Go Back</a>
                            </div>
                        </div>
                    ...
                    <div class="row" style="margin-top: 0.5%;">
                        <div class="col-md-12">
                            <div class="col-lg-12">
                                <form class="form-horizontal" role="form" id="addjobform" method="POST" action="<?php echo base_url(); ?>index.php/front_desk_c_view/add_jobs">
                                    <!-- Text input-->
...
//                    {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>index.php/front_desk_c_view/get_invoice_warranty_info?var1=" + invoice_no + "&var2=" + barcode,
                        ...
                        success: function (data) {
                            ...
                            if (data.result === "no_data") {
                                ...
                                if (data.serial_check === "serial_not_okay") {
                                    ...
                                    $("#spnmessage_3").html("<strong>There is an exisitng job for the entered serial no " + data.serial_no + "</strong><br/> Please <a href='<?php echo base_url(); ?>index.php/front_desk_c_view/view_job_detail_page?var1=" + data.job_id + "'>click here </a> to view");

                                    $("#spnmessage_4").html("<strong>There is an exisitng job for the entered serial no " + data.serial_no + "</strong><br/> Please <a href='<?php echo base_url(); ?>index.php/front_desk_c_view/view_job_detail_page?var1=" + data.job_id + "'>click here </a> to view");
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#addjobform").submit(function (e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: baseurl + "index.php/front_desk_c_view/add_jobs",
                        data: $("#addjobform").serialize(),
                        dataType: 'json',
                        success: function (data) {
                            console.log(data);
                            if (data.final_result === "success") {
                                ...
                                setTimeout(function () {
                                    //location.reload();
//                                    window.location.href = "<?php // echo base_url();   ?>index.php/front_desk_c_view/generate_job_card/" + data.job_id;


                                    window.open(
                                            '<?php echo base_url(); ?>index.php/front_desk_c_view/generate_job_card/' + data.job_id,
