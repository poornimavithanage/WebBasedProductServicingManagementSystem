                                ...
                                <div class="panel with-nav-tabs panel-default">
                                    ...
                                    <div class="panel-body" >
                                        <table id="table1" class="table table-striped table-bordered table-list dataTables-example">
                                            ...
                                            <tbody>
                                                <?php
                                                foreach ($job_estimations as $list) {
                                                    ...
                                                    echo "<td>" . $list->payment_status . "</td>";
                                                    echo "<td>" . $list->status . "</td>";
                                                    echo "<td>";
                                                    echo "<a href='" . base_url() . "index.php/front_desk_c_view/view_job_estimation_detail_page?var1=" . $list->job_id . "' class='btn btn-success btn-xs'><i class='icon-briefcase'></i>&nbsp;View</a>&nbsp; &nbsp";
                                                    echo "</tr>";
                                                }
                                                ?>
                                            </tbody>
