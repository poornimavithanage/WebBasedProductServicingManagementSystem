        ...
        <div class="container">
            ...
            <div class="tab-content">
                <div id="login" class="tab-pane active">
                    <form action="<?php echo base_url(); ?>index.php/customer_web_portal_c/login_verification" class="form-signin" method="POST">
        <!--                <p class="text-muted text-center btn-block btn btn-primary btn-rect">
                            Enter your username and password
                        </p>-->
                        <input type="text" id="username" name="username" placeholder="Username" class="form-control" />
                        <input type="password" id="password" name="password" placeholder="Password"  class="form-control" />
                        <button style="margin-top: 4%; margin-left: 15%;" class="btn text-muted text-center btn-danger" type="submit">Sign in</button>
                        <a style="margin-top: 4%;" href="<?php echo base_url(); ?>index.php/customer_web_portal_c/reset_password_request_page" class="btn btn-warning">Forgot Password</a>
                    </form>
                </div>
            </div>
                ...
                <div class="container-fluid">
                    <div class="col-md-12" id="divmessage_3">
                        <div id="spnmessage_3" class="alert alert-success alert-dismissible" role="alert">
                            <strong>Password reseted successfully Please use new password to login!</strong> 
                        </div>
                    </div>
                </div>
            </div>
