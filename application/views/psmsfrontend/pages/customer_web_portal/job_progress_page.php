                        ...
                        <div class="col-lg-offset-3 col-lg-6 col-md-6 col-sm-6">
                            <div class="timeline-centered">
                                ...
                                <article class="timeline-entry">
                                    ...
                                    <div class="timeline-entry-inner">
                                        <time class="timeline-time" datetime=""><span style="margin-left: -71px;"><?php if ($job_info[1]->status === "Technician WIP") {
                ...
                echo "";
                                ...
                                for ($b = 0; $b < count($job_info); $b++) {
                                    ...
                                    if ($job_info[$b]->final_status === "Finished not collected") {
                                        ...
                                        echo'<div class = "timeline-entry-inner">';
                                        echo'<time class = "timeline-time abc" datetime = ""><span style="margin-left: -71px;">Job Closed</span>' . $job_info[$b]->status_change_date . '<span></span></time>';
                    ...
                    <div class="row hide" style="margin-top: 0.5%;">
                        <div class="col-lg-offset-3 col-lg-6 col-md-6 col-sm-6">
                            <div class="timeline-centered">
                                ...
                                <?php
                                for ($b = 1; $b <= count($job_info) - 1; $b++) {


                                    if ($job_info[$b]->status === "Ready to Collect") {

                                        echo'<article class = "timeline-entry">';
                                        echo'<div class = "timeline-entry-inner">';
                                        echo'<time class = "timeline-time abc" datetime = ""><span style="margin-left: -71px;">' . $job_info[$b]->status . '</span>' . $job_info[$b]->status_change_date . '<span></span></time>';
                                        echo'<div class="timeline-icon bg-info">';
                                        echo'<i class="entypo-feather"></i>';
                                        echo'</div>';
                                    } else if ($job_info[$b]->status === "Completed") {
                                        ...
                                        echo'<i class="entypo-feather"></i>';
                                        echo'</div>';
                                    } else if ($job_info[$b]->status === "Job Closed") {

                                        echo'<article class = "timeline-entry begin">';
                                        echo'<div class = "timeline-entry-inner">';
                                        echo'<time class = "timeline-time abc" datetime = ""><span style="margin-left: -71px;">' . $job_info[$b]->status . '</span>' . $job_info[$b]->status_change_date . '<span></span></time>';
                                        echo'<div class = "timeline-icon" style = "-webkit-transform: rotate(-90deg); -moz-transform: rotate(-90deg);">';
                                        echo'<i class = "entypo-flight"></i>';
                                        echo'</div>';
                                    } else {
                                        ...
                                        echo'<div class = "timeline-entry-inner">';
                                        echo'<time class = "timeline-time abc" datetime = ""><span style="margin-left: -71px;">' . $job_info[$b]->status . '</span>' . $job_info[$b]->status_change_date . '<span></span></time>';
                                        echo'<div class="timeline-icon bg-warning">';
                                        echo'<i class="entypo-feather"></i>';
                                        echo'</div>';
                                    }
